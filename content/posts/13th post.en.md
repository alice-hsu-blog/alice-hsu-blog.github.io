...
(I recently started learning to draw with a drawing app, and this illustration is based on one of Fujii Kaze’s photos. I’m actually very fond of it.)
...
(Big thanks to physical therapists 啾 C and SunGuts for all the hand-stretching videos.) There are still a few imperfect spots, but overall I feel satisfied with how it turned out.

## How I arrange a piano cover
Here is the general workflow I follow:

1. Identify the vocal melody quickly and map it to the right hand.
2. Slow the track down to 0.5x to fix any rhythmic parts I misheard.
3. Write out all the chords.
4. Turn those chords into accompaniment patterns for the left hand.
5. Practice the draft version and revise anything that feels unnatural for me, and repeat that cycle as needed.
...
### Tool Two
The second tool was [Wiwi’s pitch detector](https://nicechord.com/tuner/). When the rhythm becomes fast and I cannot quite tell which note Fujii is singing, this tool becomes extremely helpful. I slow the song to 0.5x, turn on the pitch detector, and check the exact note. Since the vocals are usually the loudest in the mix, the tool works well for this purpose.
